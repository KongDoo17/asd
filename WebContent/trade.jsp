	...
	<div id="wrap">
		<div id="board">
			...
			<table>
				...
				<tr>
					<th><a
						href="<%=request.getContextPath()%>/asdController?cmd=tradepost&brx=<%=trade.get(i).getBrx()%>&cat=trade">
							<%
			...
			<input type="button" value="입력" style = "float : right" onclick="location.href='<%=request.getContextPath()%>/controller?cmd=write&category=trade'">
