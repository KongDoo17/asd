...
<body>
	...
	<div id="head">
		...
		<a href="<%=request.getContextPath()%>/asdComtroller?cmd=board"> <img src="img/asdnet.png">
	...
	<div id="wrap">
		<div id="board">
			...
			<table>
				...
				<tr>
					<th><a
						href="<%=request.getContextPath()%>/asdController?cmd=humorpost&brx=<%=humor.get(i).getBrx()%>&cat=humor">
							<%
			...
			<input type="button" value="입력" style = "float : right" onclick="location.href='<%=request.getContextPath()%>/controller?cmd=write&category=humor'">
