...
<body>
    ...
    <div id="head">
       ...
       <div id="sidemenu">
		...
		<a href="<%=session.getAttribute("id")%>/asdComtroller?cmd=board"> <img src="img/asdnet.png">
		</a>
    ...
    <div id="wrap">
        <div id="board">
            ...
            <table>
				...
				<tr>
					<th><a
						href="<%=request.getContextPath()%>/asdController?cmd=unknownspost&brx=<%=unknowns.get(i).getBrx()%>&cat=unknowns">
							<%
			...
			<input type="button" value="입력" style = "float : right" onclick="location.href='<%=request.getContextPath()%>/controller?cmd=write&category=unknowns'">
