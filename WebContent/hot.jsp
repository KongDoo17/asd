	...
	<div id="wrap" >
		<div id="board">
			...
			<table>
				...
				<tr>
					<th><a
						href="<%=request.getContextPath()%>/asdController?cmd=hotpost&brx=<%=hot.get(i).getBrx()%>&cat=hot">
							<%
			...
			<input type="button" value="입력" style = "float : right" onclick="location.href='<%=request.getContextPath()%>/controller?cmd=write&category=hot'">
